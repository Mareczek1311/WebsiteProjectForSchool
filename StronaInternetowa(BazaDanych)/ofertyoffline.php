      ...
      else if($wyszukaj != '' && $do!='' && $kategoria=='')
      {
        $result = @$connect->query(sprintf("SELECT * FROM ogloszenia WHERE nazwaogl = '$wyszukaj' AND cena < '$do'"));
			...
			while($row = mysqli_fetch_array($result)){
								...
								echo "<tr><td><img style='position:relative; height:147px; width:188px; margin-right=0%;' class='box_image' src = uploads/".$row['image']." alt=".$_SESSION['newfilename']."></td><td style='width:500px;'><p style='margin-top:-40; margin-left:10' name='ogloszenie'><b>" . $row['nazwaogl'] . "</b><br/>od <b style='font-size=20;'>".$row['sprzedawca']."</b><br/><br/> Cena: <b style='font-size:20'>".$row['cena']." zł</b><br/><a      href='Logowanie.php?id=".$row['id']."' style='text-decoration:none; color:black; font-size:24;'>Kup</a></p></td></tr>";
			}
			echo "</table>";
